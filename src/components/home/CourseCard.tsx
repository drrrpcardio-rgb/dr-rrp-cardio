  ...
  return (
    <motion.div variants={staggerItem}>
      <Link
        ...
        className="group relative flex h-full flex-col rounded-2xl border border-mist-200 bg-white p-7 transition-shadow duration-300 hover:shadow-xl hover:shadow-royal-900/5"
      >
        <motion.div
          whileHover={{ y: -6 }}
